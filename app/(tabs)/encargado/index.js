        ...
        ListHeaderComponent={
          <>
            <View style={styles.header}>
              <Text style={styles.title}>Hola, {user?.nombre?.split(' ')[0]}.</Text>
              ...
              {loading ? (
                ...
                <>
                  <View style={styles.summaryCard}>
                    ...
                    <Text style={styles.summaryText}>Asignaciones activas</Text>
                    <Text style={styles.summaryValue}>{user.asignacionesActivas.length}</Text>
                  </View>
                  <View style={styles.summaryCard}>
                    <Ionicons name="calendar" size={28} color="#4F46E5" />
                    <Text style={styles.summaryText}>Próxima asignación</Text>
                    <Text style={styles.summaryValue}>{user.proximaAsignacion ? formatDate(new Date(user.proximaAsignacion)) : 'N/A'}</Text>
                  </View>
                </>
              )}
            </View>
            ...
            <View style={styles.groupListHeader}>
              <Text style={styles.groupListTitle}>Grupos</Text>
            </View>
          </>
        }
        refreshControl={
